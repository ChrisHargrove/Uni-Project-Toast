...
#include "ProjectToast/MyActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PROJECTTOAST_API UClass* Z_Construct_UClass_AMyActor_NoRegister();
	PROJECTTOAST_API UClass* Z_Construct_UClass_AMyActor();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_ProjectToast();
	PROJECTTOAST_API UFunction* Z_Construct_UFunction_AMyActor_CalculateValues();
	PROJECTTOAST_API UFunction* Z_Construct_UFunction_AMyActor_CalledFromCpp();
// End Cross Module References
	...
	void AMyActor::StaticRegisterNativesAMyActor()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "CalledFromCpp", &AMyActor::execCalledFromCpp },
		};
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyActor_CalledFromCpp_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMyActor, "CalledFromCpp", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x08020C00, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AMyActor_CalledFromCpp_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AMyActor_CalledFromCpp_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AMyActor_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AMyActor_CalledFromCpp, "CalledFromCpp" }, // 4286329189
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMyActor, 2372972631);
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyActor(Z_Construct_UClass_AMyActor, &AMyActor::StaticClass, TEXT("/Script/ProjectToast"), TEXT("AMyActor"), false, nullptr, nullptr, nullptr);
